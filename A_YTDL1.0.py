...
print("A_YTDL1.0.py startet (Android-version, included backups and YT-cache error-handling)")
print()
print()
  ...
  # Youtube download und merge to mp3
    ...
    with youtube_dl.YoutubeDL(ydl_opts) as ydl:
          try:
              ...
              fobj_out.write("A_YTDL1.0.py with python3.8: " + timestr + ", " + trackname + ",        " + "url: " + url + '\n')
              fobj_out.close()
